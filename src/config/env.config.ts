...
// Default to Atlas URL if no environment variable is set
export const MONGODB_URI = process.env.MONGODB_URI || "mongodb+srv://moraar976:moraar254@cluster0.uoudaz5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
